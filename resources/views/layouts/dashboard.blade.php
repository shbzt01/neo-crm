...
<body>
        ...
        <div class="row">
            <div class="col-md-2 sidebar bg-light">
                <div class="list-group">
                    ...
                    <a href="{{ route('dashboard.leads.index') }}" class="list-group-item list-group-item-action @if (str_contains(request()->route()->uri, 'dashboard/leads')) active @endif" >Sales and Lead Management</a>
                    @endif
    ...
    <div class="footer">
        <p>&copy; 2024 NEO CRM. All rights reserved.</p>
    </div>
